  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppCubit, AppState>(
      ...
      builder: (context, state) {
        _nameController.text=AppCubit.get(context).userModel.fullName!;

        _phoneController.text=AppCubit.get(context).userModel.userName!;


        if (state is PickedImage) {
          _file = state.imagePath;
          AppCubit.get(context).uploadImage(_file);
        }
        ...
        return  Scaffold(
                ...
                body:AppCubit.get(context).loadUserDetails
                    ? const Center(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                                  ...
                                  child:  Image.file(_file!, height: 90,
                                    ...
                                    : ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl: AppCubit.get(context).userModel.imageUrl != null? baseurlImage +
                                              AppCubit.get(context).userModel.imageUrl!:"notFound",
                                          height: 90,
                                          fit: BoxFit.cover,
                                          width: 90,
                     ...
                     AppCubit.get(context).loadUpdate?const SizedBox(
                       height: 60,width: 60,
                       child: Center(
                         child: CircularProgressIndicator(
                           strokeWidth: 3,
                            ...
                            onPress: () {
                             if(image==""){
                               ...
                               AppCubit.get(context).updateProfile(
                                 image: "${AppCubit.get(context).userModel.imageUrl}",
