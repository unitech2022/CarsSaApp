...
class CheckUserAuthStateSuccess extends AuthState {
  ...
  CheckUserAuthStateSuccess(
      {required this.phone, required this.code, required this.status});
}
...
class GetDataLoadLoad extends AuthState {}

class GetDataLoadSuccess extends AuthState {}

class GetDataLoadError extends AuthState {}

class GetCodeLoading extends AuthState {}

class GetCodeSuccess extends AuthState {
  final String phone, code;
  GetCodeSuccess({required this.phone, required this.code});
}

class GetCodeError extends AuthState {}
