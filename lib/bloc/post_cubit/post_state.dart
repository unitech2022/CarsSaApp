...
class GetPostDataProviderLoad extends PostState {}

class GetPostDataProviderSuccess extends PostState {
    final PostResponseProvider postResponse;
  GetPostDataProviderSuccess(this.postResponse);
}




class GetPostDataProviderError extends PostState {}
